...
driver.get("https://search.shopping.naver.com/search/all?query=%EC%95%84%EC%9D%B4%ED%8F%B013&frm=NVSHATC&prevQuery=%EC%95%84%EC%9D%B4%ED%8F%B0")        # 네이버 로그인 URL로 이동

# 상품명 선택자 찾기. 여러개로 찾기(fine_elements)
names = driver.find_elements(By.CSS_SELECTOR, ".basicList_link__1MaTN")
for name in names : 
    print(name.text)